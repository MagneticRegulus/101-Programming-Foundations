...
# Yes it did becuse method reassigned all the values in the nested hash for each
# family member key. Spot did not reassign the new nested values to a new hash which
# would have not touched the original hash.
